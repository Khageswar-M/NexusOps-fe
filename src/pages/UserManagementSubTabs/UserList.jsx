...
// api
import { getAllUsers } from '../../api/users/usersApi.js';
...
const UserList = () => {
  ...
  const handleGetAllUsers = async () => {
    ...
    try {
      ...
      if (error.code === 'ERR_NETWORK') {
        showError("Error", "Server not responding, please try again after some time.");
        return;
      }
    } finally {
      setLoading(false);
  ...
  const allUsersSize = allUsers.length;
  ...
  bg-surface-3'>
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center">
              <div className="w-32 h-32 rounded-full bg-cyan-500/10 flex items-center justify-center mb-5">
                <img src={EmptyIcon} alt="" className="w-16 h-16" />
              </div>
