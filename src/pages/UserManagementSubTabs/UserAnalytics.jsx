...
const UserAnalytics = () => {
  ...
  return (
    <div className='grid grid-rows-[1fr_1fr_1fr] gap-2 h-full text-white'>
      ...
      {/* ROW 2 */}
      <div className='grid grid-cols-[1fr_1fr_1fr] h-full gap-2 [&>div]:rounded-md [&>div]:bg-surface '>
        ...
        <div className='grid grid-rows-[1fr_5fr] overflow-hidden'>
          ...
          <div className='grid grid-cols-[1fr_1fr] gap-1 relative '>
            <div className='flex items-center justify-center'>
              <CustomPieChart data={roleDistribution} />
            </div>
            <div className='grid grid-cols-1 relative p-2 overflow-hidden '>
