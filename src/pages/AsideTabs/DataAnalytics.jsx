...
const DataAnalytics = () => {
  ...
  return (
    ...
    ${width >= 1313 ? "grid-rows-[1fr_2fr]" : 
      width > 700 ? "grid-rows-3" : "grid-cols-1"
    }
    grid-cols-1 gap-2 ${width <= 700 ? "overflow-y-auto" : "overflow-hidden"}}`}>
      {/* ROW ONE */}
      <div className={`grid ${width >= 1313 ? "grid-cols-3" : width >= 700 ? "grid-cols-2" : "grid-cols-1"}  grid-rows-1 gap-2 [&>div]:rounded-md overflow-hidden`}>
      ...
      {
        width <= 1313 && (
          <div className={`grid ${width <= 700 ? "grid-cols-1" :  "grid-cols-2 grid-rows-1"}  [&>div]:rounded-md [&>div]:border [&>div]:border-border gap-2`}>
            <div className="bg-surface relative border border-border grid grid-rows-[1fr_5fr] grid-cols-1">
              {/* HEADER */}
              <div className="border-b border-border px-2 flex flex-row items-center">
                <HeadBar title={"Task Automation Breakdown"} color={"cyan"} />
            ...
            <div className="grid grid-rows-[1fr_4.5fr] bg-surface grid-cols-1 overflow-hidden">
      ...
      {/* ROW TWO */}
      <div className={` grid ${width <= 700 ? "grid-cols-1" : "grid-cols-[1.5fr_1fr]"} grid-rows-1 gap-2 [&>div]:rounded-md overflow-hidden`}>
        ...
        {/* PROCESSING EFFICIENCY */}
        <div className={`grid  ${width <= 1313 ? "grid-rows-1" : "grid-rows-[1fr_1fr]"} grid-cols-1 gap-2 [&>div]:bg-surface [&>div]:rounded-md [&>div]:border [&>div]:border-border overflow-hidden`}>
          {
            width >= 1313 && (
